!function (e) {
    ...
    t.attachRootComponentToLogicalElement = i,
        ...
        t.renderBatch = function (e, t) {
            ...
            for (var r = t.arrayRangeReader, o = t.updatedComponents(), i = r.values(o), u = r.count(o), l = t.referenceFrames(), s = r.values(l), c = t.diffReader, f = 0; f < u; f++) {
            ...
            e.attachDispatcher = function (e) {
                ...
                e.jsCallDispatcher = {
                    ...
                    invokeJSFromDotNet: function (e, t) {
                        var n = m(e).apply(null, d(t));
                        return null == n ? null : JSON.stringify(n, y)
                    },
                    beginInvokeJSFromDotNet: function (e, t, n) {
                        var r = new Promise(function (e) {
                            e(m(t).apply(null, d(n)))
                        }
                        );
                        e && r.then(function (t) {
                            return c().beginInvokeDotNetFromJS(0, "Microsoft.JSInterop", "DotNetDispatcher.EndInvoke", null, JSON.stringify([e, !0, t], y))
                        }, function (t) {
                            return c().beginInvokeDotNetFromJS(0, "Microsoft.JSInterop", "DotNetDispatcher.EndInvoke", null, JSON.stringify([e, !1, p(t)]))
                        })
                    },
            ...
            var h = function () {
                ...
                return e.prototype.invokeMethod = function (e) {
                    ...
                    e.prototype.dispose = function () {
                        u("Microsoft.JSInterop", "DotNetDispatcher.ReleaseDotNetObject", this._id).catch(function (e) {
        ...
        function f(e) {
            return r(this, void 0, void 0, function () {
                return o(this, function (t) {
                    switch (t.label) {
                        case 0:
                            return l ? [4, DotNet.invokeMethodAsync(l.assemblyName, l.functionName, location.href, e)] : [3, 2];
                        case 1:
                            t.sent(),
                                t.label = 2;
                        case 2:
    ...
    , function (e, t, n) {
        ...
        var a, i, u = n(13), l = "Microsoft.AspNetCore.Blazor", s = l + ".Http", c = "WebAssemblyHttpMessageHandler";
        function f(e, t, n, r) {
        ...
        var r = n(24)
            ...
            , f = function () {
                ...
                return e.prototype.attachRootComponentToLogicalElement = function (e, t) {
                    ...
                    ,
                    e.prototype.applyEdits = function (e, t, n, o, i) {
                        for (var u, l = 0, s = n, c = e.arraySegmentReader, f = e.editReader, d = e.frameReader, p = c.values(o), m = c.offset(o), h = m + c.count(o), y = m; y < h; y++) {
                            var v = e.diffReader.editsEntry(p, y)
                                , g = f.editType(v);
                            switch (g) {
                                case r.EditType.prependFrame:
                                    var b = f.newTreeIndex(v)
                                        , w = e.referenceFramesEntry(i, b)
                                        , E = f.siblingIndex(v);
                                    this.insertFrame(e, t, s + E, i, w, b);
                                    break;
                                case r.EditType.removeFrame:
                                    E = f.siblingIndex(v);
                                    a.removeLogicalChild(t, s + E);
                                    break;
                                case r.EditType.setAttribute:
                                    b = f.newTreeIndex(v),
                                        w = e.referenceFramesEntry(i, b),
                                        E = f.siblingIndex(v);
                                    if (!((S = a.getLogicalChild(t, s + E)) instanceof Element))
                                        throw new Error("Cannot set attribute on non-element child");
                                    this.applyAttribute(e, S, w);
                                    break;
                                case r.EditType.removeAttribute:
                                    var S;
                                    E = f.siblingIndex(v);
                                    if (!((S = a.getLogicalChild(t, s + E)) instanceof HTMLElement))
                                        throw new Error("Cannot remove attribute from non-element child");
                                    var _ = f.removedAttributeName(v);
                                    this.tryApplySpecialProperty(e, S, _, null) || S.removeAttribute(_);
                                    break;
                                case r.EditType.updateText:
                                    b = f.newTreeIndex(v),
                                        w = e.referenceFramesEntry(i, b),
                                        E = f.siblingIndex(v);
                                    var I = a.getLogicalChild(t, s + E);
                                    if (!(I instanceof Text))
                                        throw new Error("Cannot set text content on non-text child");
                                    I.textContent = d.textContent(w);
                                    break;
                                case r.EditType.updateMarkup:
                                    b = f.newTreeIndex(v),
                                        ...
                                        E = f.siblingIndex(v);
                                    a.removeLogicalChild(t, s + E),
                                        this.insertMarkup(e, t, s + E, w);
                                    break;
                                case r.EditType.stepIn:
                                    E = f.siblingIndex(v);
                                    t = a.getLogicalChild(t, s + E),
                                        l++ ,
                                        s = 0;
                                    break;
                                case r.EditType.stepOut:
                                    t = a.getLogicalParent(t),
                                        s = 0 === --l ? n : 0;
                                    break;
                                case r.EditType.permutationListEntry:
                                    (u = u || []).push({
                                        fromSiblingIndex: s + f.siblingIndex(v),
                                        toSiblingIndex: s + f.moveToSiblingIndex(v)
                                    });
                                    break;
                                case r.EditType.permutationListEnd:
                                    a.permuteLogicalChildren(t, u),
                                        u = void 0;
                                    break;
                                default:
                    ...
                    ,
                    e.prototype.insertFrame = function (e, t, n, o, a, u) {
                        var l = e.frameReader
                            , s = l.frameType(a);
                        switch (s) {
                            case r.FrameType.element:
                                return this.insertElement(e, t, n, o, a, u),
                                    1;
                            case r.FrameType.text:
                                return this.insertText(e, t, n, a),
                                    1;
                            case r.FrameType.attribute:
                                throw new Error("Attribute frames should only be present as leading children of element frames.");
                            case r.FrameType.component:
                                return this.insertComponent(e, t, n, a),
                                    1;
                            case r.FrameType.region:
                                return this.insertFrameRange(e, t, n, o, u + 1, u + l.subtreeLength(a));
                            case r.FrameType.elementReferenceCapture:
                                if (t instanceof Element)
                                    return i.applyCaptureIdToElement(t, l.elementReferenceCaptureId(a)),
                                        0;
                                throw new Error("Reference capture frames can only be children of element frames.");
                            case r.FrameType.markup:
                                return this.insertMarkup(e, t, n, a),
                                    1;
                            default:
                    ...
                    ,
                    e.prototype.insertElement = function (e, t, n, o, i, u) {
                        var l = e.frameReader
                            , s = l.elementName(i)
                            , c = "svg" === s || a.isSvgElement(t) ? document.createElementNS("http://www.w3.org/2000/svg", s) : document.createElement(s)
                            , f = a.toLogicalElement(c);
                        a.insertLogicalChild(c, t, n);
                        for (var d = u + l.subtreeLength(i), p = u + 1; p < d; p++) {
                            var m = e.referenceFramesEntry(o, p);
                            if (l.frameType(m) !== r.FrameType.attribute) {
                                this.insertFrameRange(e, f, 0, o, p, d);
                                break
                            }
                            this.applyAttribute(e, c, m)
                        }
                    }
                    ,
                    ...
                    ,
                    e.prototype.insertFrameRange = function (e, t, n, r, o, a) {
                        for (var i = n, u = o; u < a; u++) {
                            var l = e.referenceFramesEntry(r, u);
                            n += this.insertFrame(e, t, n, r, l, u),
                                u += d(e, l)
                        }
                        return n - i
                    }
                            ...
                            for (var t = e.target, n = null, r = a.hasOwnProperty(e.type); t;) {
                                if (t.hasOwnProperty(this.eventsCollectionKey)) {
                                    ...
                                    if (i.hasOwnProperty(e.type)) {
                                        ...
                                        var u = i[e.type];
                                        this.onEvent(e, u.eventHandlerId, n)
                                    }
                                }
            ...
            return r(this, void 0, void 0, function () {
                ...
                return o(this, function (o) {
                    switch (o.label) {
                        ...
                        case 4:
                            throw d = o.sent(),
                            new Error("Failed to start platform. Reason: " + d);
                        case 5:
                            return [4, n];
                        case 6:
                            return o.sent(),
                                p = u.getAssemblyNameFromUrl(t.main),
                                e.callEntryPoint(p, t.entryPoint, []),
                                [2]
                    }
                })
            })
        }
        window.Blazor.start = d,
            c.shouldAutoStart() && d()
    }
    , function (e, t, n) {
        "use strict";
        ...
        var r, o, a, i, u, l, s = n(28), c = n(44), f = {}, d = {}, p = {}, m = "appBinDir";
        function h(e, t, n) {
            var a = "[" + e + "]" + t + "." + n
                , i = d[a];
            if (!i) {
                            ...
                            return d.print = function (e) {
                                ...
                                d.postRun.push(function () {
                                    ...
                                    MONO.mono_wasm_setenv("MONO_URI_DOTNETRELATIVEORABSOLUTE", "true"),
                                        ...
                                        e = y("Mono.WebAssembly.Interop", "Mono.WebAssembly.Interop", "MonoWebAssemblyJSRuntime", "InvokeDotNet"),
                                        r = y("Mono.WebAssembly.Interop", "Mono.WebAssembly.Interop", "MonoWebAssemblyJSRuntime", "BeginInvokeDotNet"),
